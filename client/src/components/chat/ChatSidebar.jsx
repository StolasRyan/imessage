...
const ChatSidebar = () => {
  ...
  const noramlizedSearchQuery = searchQuery.trim().toLowerCase();
  ...
  const filteredConversations = noramlizedSearchQuery
    ? conversationUsers.filter((conversation) =>
        conversation.peer.name.toLowerCase().includes(noramlizedSearchQuery),
      )
    : conversationUsers;

  const filteredUsers = noramlizedSearchQuery
    ? allUsers.filter((user) =>
        user.name.toLowerCase().includes(noramlizedSearchQuery),
      )
    : allUsers;
