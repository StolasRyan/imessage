...
const AuthHeader = () => {
  return (
    <header className="sticky top-0 z-50 flex shrink-0 items-center gap-2 border-b border-black/10 bg-[#F6F6F6]/95 px-3 py-2 backdrop-blur-md dark:border-white/10 dark:bg-[#1C1C1E]/95" >
